...
{
  /** @var string $entity Tabela do banco de dados */
  ...
  public function bootstrap(string $first_name, string $last_name, string $email): User
  {
  ...
  public function save(): ?User
  {
    ...
    if(!empty($this->id)) {
      ...
      if ($this->fail()) {
        $this->message = "Não foi possível atualzar, verifique os dados!";
        return null;
      }
